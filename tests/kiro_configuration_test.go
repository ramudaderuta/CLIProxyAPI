...
// TestKiroConfiguration_TokenFilePrecedence validates that explicitly configured
// token files take precedence over auto-detected files.
func TestKiroConfiguration_TokenFilePrecedence(t *testing.T) {
...
// TestKiroConfiguration_NativeTokenEnhancement validates that native Kiro tokens
// (without "type": "kiro") are automatically enhanced in memory.
func TestKiroConfiguration_NativeTokenEnhancement(t *testing.T) {
	// Create temporary directory for test
	tempDir := t.TempDir()
...
// TestKiroConfiguration_BackwardCompatibility validates that existing Kiro token files
// continue to work with the new implementation.
func TestKiroConfiguration_BackwardCompatibility(t *testing.T) {
...
// TestKiroConfiguration_HotReloading validates that configuration changes are
// properly detected and applied.
func TestKiroConfiguration_HotReloading(t *testing.T) {
	// Create temporary directory for test
	tempDir := t.TempDir()
